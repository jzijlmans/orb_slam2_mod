...
if len(sys.argv) == 3: #if the user has provided enough arguments
    ...
    print "Please supply two arguments as following: VideoToBag.py videopath imagefolder [orb-slam2] \n When adding \"orb-slam2\", the nessary tekst file wil also be created."
